...
#    # setup routes
#    Create Route On agent_vpp_2 With IP ${NET2}/64 With Next Hop ${IP_1} And Vrf Id 0
#    Create Route On agent_vpp_3 With IP ${NET1}/64 With Next Hop ${IP_3} And Vrf Id 0
#
#    Sleep    15s
#
#    # try ping
...
#    IP6 Fib Table 2 On agent_vpp_2 Should Contain Route With IP ${IP_2}/32
#
#    # try ping
#    Ping6 From agent_vpp_1 To ${IP_2}
