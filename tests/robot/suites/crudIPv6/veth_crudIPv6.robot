...
Check That Veth1 And Veth2 Interfaces Are Created
    ...
    linux: Check Veth Interface State     agent_vpp_1    vpp1_veth1    mac=${VETH1_MAC}    ipv6=${VETHIP1}/64    mtu=1500    state=up
...
Update Veth1 Interface
    ...
    linux: Check Veth Interface State     agent_vpp_1    vpp1_veth1    mac=${VETH1_SEC_MAC}    ipv6=${VETHIP3}/64    mtu=1600    state=up
