...
Check CRUD For Local SID With END Function (Base End)
    Put Local SID With Base End function    node=agent_vpp_1    sidAddress=a::    installationVrfId=0
...
Check CRUD For Local SID With END.X Function
    Put Local SID With End.X function    node=agent_vpp_1    sidAddress=a::    installationVrfId=0          outinterface=vpp1_afpacket1           nexthop=a::1    psp=false
    ...
    Put Local SID With End.X function    node=agent_vpp_1    sidAddress=a::    installationVrfId=0          outinterface=vpp1_afpacket1           nexthop=c::1    psp=false   #modification
...
Check CRUD For Local SID With END.DX4 Function
    Put Local SID With End.DX4 function    node=agent_vpp_1    sidAddress=a::    installationVrfId=0          outinterface=vpp1_afpacket1           nexthop=1.1.1.1
    ...
    Put Local SID With End.DX4 function    node=agent_vpp_1    sidAddress=a::    installationVrfId=0          outinterface=vpp1_afpacket1           nexthop=1.1.1.2   #modification
...
Check CRUD For Local SID With END.DX6 Function
    Put Local SID With End.DX6 function    node=agent_vpp_1    sidAddress=a::    installationVrfId=0          outinterface=vpp1_afpacket1           nexthop=a::1
    ...
    Put Local SID With End.DX6 function    node=agent_vpp_1    sidAddress=a::    installationVrfId=0          outinterface=vpp1_afpacket1           nexthop=c::1   #modification
...
Check Policy CRUD
    Put SRv6 Policy                    node=agent_vpp_1    bsid=a::e    segmentlists=${segmentLists1weight1}    installationVrfId=0         srhEncapsulation=true      sprayBehaviour=true
    ...
    Put SRv6 Policy                    node=agent_vpp_1    bsid=a::e    segmentlists=${segmentLists1weight1}    installationVrfId=0         srhEncapsulation=false      sprayBehaviour=true    # modification of non-segment list part
    ...
    Put SRv6 Policy                    node=agent_vpp_1    bsid=a::e    segmentlists=${segmentLists12weight12}    installationVrfId=0         srhEncapsulation=false      sprayBehaviour=true    # modification - adding one new segment list (+preserving one existing segment key)
    ...
    Put SRv6 Policy                    node=agent_vpp_1    bsid=a::e    segmentlists=${segmentLists23weight23}    installationVrfId=0         srhEncapsulation=false      sprayBehaviour=true    # modification - mixing addition of mew segment list with removal of existing segment list (+preserving one existing segment key)
    ...
    Put SRv6 Policy                    node=agent_vpp_1    bsid=a::e    segmentlists=${segmentLists3weight3}    installationVrfId=0         srhEncapsulation=false      sprayBehaviour=true    # modification - removing of existing segment list (+preserving one existing segment key)
    ...
    Put SRv6 Policy                    node=agent_vpp_1    bsid=a::e    segmentlists=${segmentLists3weight4}    installationVrfId=0         srhEncapsulation=false      sprayBehaviour=true    # modification - modify weight of existing segment list
    ...
    Put SRv6 Policy                    node=agent_vpp_1    bsid=a::e    segmentlists=${segmentLists4weight4}    installationVrfId=0         srhEncapsulation=false      sprayBehaviour=true    # modification - modify segments of existing segment list
...
Check Update Of Policy Should Not Trigger Cascade Delete Of Steering
    ...
    Wait Until Keyword Succeeds   ${WAIT_TIMEOUT}   ${SYNC_SLEEP}    vpp_term: Check SRv6 Steering Presence      node=agent_vpp_1    bsid=a::e    prefixAddress=e::/64
    Wait Until Keyword Succeeds   ${WAIT_TIMEOUT}   ${SYNC_SLEEP}    vpp_term: Check SRv6 Policy Presence        node=agent_vpp_1    bsid=a::e    fibtable=0    behaviour=Encapsulation    type=Spray    index=0    segmentlists=${segmentLists1weight1}
    Put SRv6 Policy                    node=agent_vpp_1    bsid=a::e       installationVrfId=0         srhEncapsulation=false    sprayBehaviour=true    segmentlists=${segmentLists1weight1}    #modification of non-segment attribute
