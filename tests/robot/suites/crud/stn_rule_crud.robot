...
Check TAP1 Interface Is Created
    ...
    ${actual_state}=    vpp_term: Check TAP interface State    agent_vpp_1
    ...    ${NAME_TAP1}    mac=${MAC_TAP1}    ipv4=${IP_TAP1}/${PREFIX}    state=${UP_STATE}
...
Check TAP2 Interface Is Created
    ...
    ...    mac=${MAC_TAP2}    ipv4=${IP_TAP2}/${PREFIX}    state=${UP_STATE}
