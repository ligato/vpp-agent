...
${VETH2_IP}=             10.10.1.2
${PREFIX}=               24
${MEMIF_IP}=             192.168.1.1
${VXLAN_IP_SRC}=         192.168.1.1
${VXLAN_IP_DST}=         192.168.1.2
${LOOPBACK_IP}=          20.20.1.1
${TAP_IP}=               30.30.1.1
...
Add Veth1 Interface Pair
    ...
    ...    mac=${VETH1_MAC}    ipv4=${VETH1_IP}/${PREFIX}    mtu=1500    state=up
    Wait Until Keyword Succeeds   ${WAIT_TIMEOUT}   ${SYNC_SLEEP}
    ...    linux: Check Veth Interface State     agent_vpp_1    vpp1_veth2
    ...    mac=${VETH2_MAC}    ipv4=${VETH2_IP}/${PREFIX}    mtu=1500    state=up
...
Add Memif Interface
    ...
    ...    mac=62:61:61:61:61:61  role=master  id=1  ipv4=${MEMIF_IP}/${PREFIX}
...
Add Loopback Interface
    ...
    ...    enabled=1     mac=12:21:21:11:11:11    mtu=1400  ipv4=${LOOPBACK_IP}/${PREFIX}
...
Add Tap Interface
    ...
    ...    mac=32:21:21:11:11:11    ipv4=${TAP_IP}/${PREFIX}    state=up
