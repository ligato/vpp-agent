...
Check IPsec config_1 On VPP
    Wait Until Keyword Succeeds   ${WAIT_TIMEOUT}   ${SYNC_SLEEP}    IP Sec Should Contain  agent_vpp_1  sa 10  sa 20  spd 1  ip4-outbound   ip4-inbound-protect
...
Check IPsec config_2 On VPP
    Wait Until Keyword Succeeds   ${WAIT_TIMEOUT}   ${SYNC_SLEEP}    IP Sec Should Contain  agent_vpp_1  sa 30  sa 40  spd 2  ip4-outbound   ip4-inbound-protect
