...
Check IPsec config_1 On VPP
    IP Sec Should Contain  agent_vpp_1  sa 10  sa 20  spd 1  inbound policies  outbound policies
...
Check IPsec config_2 On VPP
    IP Sec Should Contain  agent_vpp_1  sa 30  sa 40  spd 2  inbound policies    outbound policies
...
Delete SAs And SPD1 For Default IPsec
    ...
    IP Sec On agent_vpp_1 Should Not Contain SA sa 10
    IP Sec On agent_vpp_1 Should Not Contain SA sa 20
    IP Sec On agent_vpp_1 Should Not Contain SA spd 1
...
Delete SAs And SPD2 For Default IPsec
    ...
    IP Sec On agent_vpp_1 Should Not Contain SA sa 30
    IP Sec On agent_vpp_1 Should Not Contain SA sa 40
    IP Sec On agent_vpp_1 Should Not Contain SA spd 2
