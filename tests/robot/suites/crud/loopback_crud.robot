...
${MAC_LOOP1_2}=     13:21:21:11:11:11
${MAC_LOOP2}=       22:21:21:11:11:11
${IP_LOOP1}=        20.20.1.1
...
Add Looback1 Interface
    vpp_term: Interface Not Exists  node=agent_vpp_1    mac=${MAC_LOOP1}
    vpp_ctl: Put Loopback Interface With IP    node=agent_vpp_1     name=${NAME_LOOP1}    mac=${MAC_LOOP1}    ip=${IP_LOOP1}

Check Loopback1 is created
    vpp_term: Interface Is Created    node=agent_vpp_1    mac=${MAC_LOOP1}
    vat_term: Check Loopback Interface State    agent_vpp_1     ${NAME_LOOP1}     enabled=1     mac=${MAC_LOOP1}

Add Looback2 Interface
    vpp_term: Interface Not Exists  node=agent_vpp_1    mac=${MAC_LOOP2}
    vpp_ctl: Put Loopback Interface With IP    node=agent_vpp_1     name=${NAME_LOOP2}    mac=${MAC_LOOP2}    ip=${IP_LOOP2}

Check Loopback2 is created
    vpp_term: Interface Is Created    node=agent_vpp_1    mac=${MAC_LOOP2}
    vat_term: Check Loopback Interface State    agent_vpp_1    ${NAME_LOOP2}        enabled=1     mac=${MAC_LOOP2}

Check Loopback1 Is Still Configured
    vat_term: Check Loopback Interface State    agent_vpp_1    ${NAME_LOOP1}     enabled=1     mac=${MAC_LOOP1}

Update Loopback1
    vpp_ctl: Put Loopback Interface With IP    node=agent_vpp_1     name=${NAME_LOOP1}    mac=${MAC_LOOP1_2}    ip=${IP_LOOP1_2}
    ...
    vat_term: Check Loopback Interface State    agent_vpp_1    ${NAME_LOOP1}       enabled=1     mac=${MAC_LOOP1_2}
