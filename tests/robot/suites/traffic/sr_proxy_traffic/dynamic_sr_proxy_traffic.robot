...
Common Setup Used Across All Tests
    ...
    Put SRv6 Policy            node=agent_vpp_1    name=AtoC            bsid=A::C          fibtable=0         srhEncapsulation=true    sprayBehaviour=false
    Put SRv6 Policy Segment    node=agent_vpp_1    name=firstSegment    policyName=AtoC    policyBSID=A::C    weight=1                 segmentlist=${segmentList}
...
Dynamic SR Proxy with L3-IPv6 SR-unaware service
    ...
    Create Route On agent_vpp_4 With IP ${linux_vpp3_tap_ipv6}/64 With Vrf Id 0 With Interface service_out_memif And Next Hop BD:2::B
    ...
    Create Route On agent_vpp_3 With IP ${linux_vpp1_tap_ipv6}/64 With Vrf Id 0 With Interface vpp3_memif2 And Next Hop AC::A
...
Dynamic SR Proxy with L3-IPv4 SR-unaware service
    ...
    ## creating service routes (Service just sends received packets back)
    Create Route On agent_vpp_4 With IP ${linux_vpp3_tap_ipv4}/24 With Vrf Id 0 With Interface service_out_memif And Next Hop ${srproxy_in_memif_ipv4}
    ## configure exit from segment routing
    ...
    Create Route On agent_vpp_3 With IP ${linux_vpp1_tap_ipv4}/24 With Vrf Id 0 With Interface vpp3_memif2 And Next Hop ${vpp1_memif2_ipv4}
