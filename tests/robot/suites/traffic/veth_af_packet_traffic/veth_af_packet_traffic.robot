...
Configure Interfaces
    ...
    vpp_ctl: Put Veth Interface With IP And Namespace       node=agent_vpp_1    name=node1_veth    namespace=node_1    mac=12:11:11:11:11:11    peer=vpp1_veth1    ip=10.0.0.10    #vrf=0
    ...
    vpp_ctl: Put Veth Interface With IP And Namespace       node=agent_vpp_1    name=node2_veth    namespace=node_2    mac=12:11:11:11:11:12    peer=vpp1_veth2    ip=10.0.0.11    #vrf=0
    ...
    vpp_ctl: Put Veth Interface With IP And Namespace       node=agent_vpp_1    name=node3_veth    namespace=node_3    mac=12:11:11:11:11:13    peer=vpp1_veth3    ip=10.0.0.12    #vrf=0
...
Check Stuff
    ...
    #Bug: CV-595
    Wait Until Keyword Succeeds   60s   ${SYNC_SLEEP}    vat_term: Check Afpacket Interface State    agent_vpp_1    vpp1_afpacket1    enabled=1
