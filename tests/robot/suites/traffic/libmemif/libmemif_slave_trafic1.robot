...
Check Memif1 Interface Created And Connected On VPP2
    vpp_term: Interface Is Created    node=agent_vpp_2    mac=62:61:61:61:51:51
    vat_term: Check Memif Interface State     agent_vpp_2  vpp2_memif1  mac=62:61:61:61:51:51  role=slave  id=0  ipv4=${VPP2MEMIF_IP1}/24  connected=1  enabled=1  socket=${AGENT_LIBMEMIF_1_MEMIF_SOCKET_FOLDER}/memif.sock
...
Delete Memif1 Interface On VPP2
    ...
    vpp_term: Interface Is Deleted    node=agent_vpp_2    mac=62:61:61:61:51:51
...
Check Memif2 Interface Created On VPP1
    ...
    vat_term: Check Memif Interface State     agent_vpp_1  vpp1_memif2  mac=62:61:61:61:51:51  role=master  id=1  ipv4=${VPP1MEMIF_IP2}/24  connected=1  enabled=1  socket=${AGENT_LIBMEMIF_1_MEMIF_SOCKET_FOLDER}/memif.sock
...
Check Memif2 Interface Created On VPP1
    vpp_term: Interface Is Created    node=agent_vpp_1    mac=62:61:61:61:51:51
    vat_term: Check Memif Interface State     agent_vpp_1  vpp1_memif2  mac=62:61:61:61:51:51  role=master  id=1  ipv4=${VPP1MEMIF_IP2}/24  connecte
