...
Open_CCMTS1_Connections
    ...
    ${vswitch_ip} =     BuiltIn.Evaluate    &{client_pod_details}[${vswitch_pod_name}]["IP"]
    ...
    ${cn_infra_ip} =     BuiltIn.Evaluate    &{client_pod_details}[${cn_infra_pod_name}]["IP"]
    ...
    ${sfc_ip} =     BuiltIn.Evaluate    &{client_pod_details}[${sfc_pod_name}]["IP"]
    ...
    ${etcd_ip} =     BuiltIn.Evaluate    &{client_pod_details}[${etcd_pod_name}]["IP"]
    ...
    ${kafka_ip} =     BuiltIn.Evaluate    &{client_pod_details}[${kafka_pod_name}]["IP"]
