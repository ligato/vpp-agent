...
// source: ligato/vpp-agent/api/models/linux/iptables/iptables.proto
...
func (RuleChain_Protocol) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_13c91db3dee030c3, []int{0, 0}
}
...
func (RuleChain_Table) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_13c91db3dee030c3, []int{0, 1}
}
...
func (RuleChain_ChainType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_13c91db3dee030c3, []int{0, 2}
}
...
func (RuleChain_Policy) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_13c91db3dee030c3, []int{0, 3}
}
...
func (*RuleChain) Descriptor() ([]byte, []int) {
	return fileDescriptor_13c91db3dee030c3, []int{0}
}
...
func init() {
	proto.RegisterFile("ligato/vpp-agent/api/models/linux/iptables/iptables.proto", fileDescriptor_13c91db3dee030c3)
}

var fileDescriptor_13c91db3dee030c3 = []byte{
	// 509 bytes of a gzipped FileDescriptorProto
	,
}
