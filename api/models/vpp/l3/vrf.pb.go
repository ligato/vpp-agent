...
func (VrfTable_Protocol) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_vrf_e04bcc05f3e1cd73, []int{0, 0}
}
...
func (*VrfTable) Descriptor() ([]byte, []int) {
	return fileDescriptor_vrf_e04bcc05f3e1cd73, []int{0}
}
...
func (dst *VrfTable) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VrfTable.Merge(dst, src)
}
...
func init() { proto.RegisterFile("models/vpp/l3/vrf.proto", fileDescriptor_vrf_e04bcc05f3e1cd73) }

var fileDescriptor_vrf_e04bcc05f3e1cd73 = []byte{
