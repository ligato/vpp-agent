...
//
func DumpInterfaces(log logging.Logger, vppChan govppapi.VPPChannel, stopwatch *measure.Stopwatch) (map[uint32]*Interface, error) {
	start := time.Now()
...
func DumpMemifSocketDetails(log logging.Logger, vppChan govppapi.VPPChannel, timeLog measure.StopWatchEntry) (map[string]uint32, error) {
...
func dumpIPAddressDetails(log logging.Logger, vppChan govppapi.VPPChannel, ifs map[uint32]*Interface, isIPv6 uint8, timeLog measure.StopWatchEntry) error {
...
func dumpMemifDetails(log logging.Logger, vppChan govppapi.VPPChannel, ifs map[uint32]*Interface, timeLog measure.StopWatchEntry) error {
...
func dumpTapDetails(log logging.Logger, vppChan govppapi.VPPChannel, ifs map[uint32]*Interface, timeLog measure.StopWatchEntry) error {
...
func dumpVxlanDetails(log logging.Logger, vppChan govppapi.VPPChannel, ifs map[uint32]*Interface, timeLog measure.StopWatchEntry) error {
