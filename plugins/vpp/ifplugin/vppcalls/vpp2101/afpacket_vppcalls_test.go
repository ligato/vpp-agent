...
import (
	...
	vpp_afpacket "go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2101/af_packet"
	...
	"go.ligato.io/vpp-agent/v3/plugins/vpp/ifplugin/vppcalls/vpp2101"
)
...
func TestAddAfPacketInterfaceMac(t *testing.T) {
	...
	mac, err := vpp2101.ParseMAC("a2:01:01:01:01:01")
	Expect(err).To(BeNil())
