...
import (
	...
	vpp_interfaces "go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2101/interface"
	...
	vpp_ipip "go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2101/ipip"
...
func TestDumpInterfacesTap2(t *testing.T) {
	...
	hwAddr1Parse, err := vpp2101.ParseMAC("01:23:45:67:89:ab")
	Expect(err).To(BeNil())
