...
func AddBfdUDPSession(bfdSess *bfd.SingleHopBFD_Session, ifIdx uint32, bfdKeyIndexes idxvpp.NameToIdx,
	log logging.Logger, vppChan govppapi.VPPChannel, stopwatch *measure.Stopwatch) error {
...
func ModifyBfdUDPSession(bfdSess *bfd.SingleHopBFD_Session, swIfIndexes ifaceidx.SwIfIndex, vppChan govppapi.VPPChannel, stopwatch *measure.Stopwatch) (err error) {
	defer func(t time.Time) {
...
func DeleteBfdUDPSession(ifIndex uint32, sourceAddress string, destAddress string, vppChan govppapi.VPPChannel, stopwatch *measure.Stopwatch) error {
	defer func(t time.Time) {
...
func DumpBfdUDPSessions(vppChan govppapi.VPPChannel, stopwatch *measure.Stopwatch) ([]*bfd_api.BfdUDPSessionDetails, error) {
...
func DumpBfdUDPSessionsWithID(authKeyIndex uint32, vppChan govppapi.VPPChannel, stopwatch *measure.Stopwatch) ([]*bfd_api.BfdUDPSessionDetails, error) {
	return dumpBfdUDPSessionsWithID(true, authKeyIndex, vppChan, stopwatch)
}

func dumpBfdUDPSessionsWithID(filterID bool, authKeyIndex uint32, vppChan govppapi.VPPChannel, stopwatch *measure.Stopwatch) (sessions []*bfd_api.BfdUDPSessionDetails, err error) {
	defer func(t time.Time) {
...
func SetBfdUDPAuthenticationKey(bfdKey *bfd.SingleHopBFD_Key, log logging.Logger, vppChan govppapi.VPPChannel, stopwatch *measure.Stopwatch) (err error) {
	defer func(t time.Time) {
...
func DeleteBfdUDPAuthenticationKey(bfdKey *bfd.SingleHopBFD_Key, vppChan govppapi.VPPChannel, stopwatch *measure.Stopwatch) (err error) {
	defer func(t time.Time) {
...
func DumpBfdKeys(vppChan govppapi.VPPChannel, stopwatch *measure.Stopwatch) (keys []*bfd_api.BfdAuthKeysDetails, err error) {
	defer func(t time.Time) {
...
func AddBfdEchoFunction(bfdInput *bfd.SingleHopBFD_EchoFunction, swIfIndexes ifaceidx.SwIfIndex, vppChan govppapi.VPPChannel, stopwatch *measure.Stopwatch) (err error) {
	defer func(t time.Time) {
...
func DeleteBfdEchoFunction(vppChan govppapi.VPPChannel, stopwatch *measure.Stopwatch) (err error) {
	defer func(t time.Time) {
