...
func AddTapInterface(ifName string, tapIf *interfaces.Interfaces_Interface_Tap, vppChan govppapi.VPPChannel, stopwatch *measure.Stopwatch) (swIfIdx uint32, err error) {
...
func DeleteTapInterface(ifName string, idx uint32, version uint32, vppChan govppapi.VPPChannel, stopwatch *measure.Stopwatch) error {
	defer func(t time.Time) {
