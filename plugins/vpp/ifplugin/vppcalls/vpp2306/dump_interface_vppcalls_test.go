...
import (
	...
	vpp_gtpu "go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2306/gtpu"
	vpp_interfaces "go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2306/interface"
	...
	vpp_ipip "go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2306/ipip"
	...
	vpp2306 "go.ligato.io/vpp-agent/v3/plugins/vpp/ifplugin/vppcalls/vpp2306"
...
func TestDumpInterfacesTap2(t *testing.T) {
	...
	hwAddr1Parse, err := vpp2306.ParseMAC("01:23:45:67:89:ab")
	Expect(err).To(BeNil())
