...
import (
	...
	vpp_interfaces "go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2106/interface"
	...
	vpp_ipip "go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2106/ipip"
	vpp_memif "go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2106/memif"
	vpp_tapv2 "go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2106/tapv2"
	vpp_vpe "go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2106/vpe"
	vpp_vxlan "go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2106/vxlan"
	vpp_vxlangpe "go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2106/vxlan_gpe"
...
func TestDumpInterfacesTap2(t *testing.T) {
	...
	hwAddr1Parse, err := vpp2106.ParseMAC("01:23:45:67:89:ab")
	Expect(err).To(BeNil())
