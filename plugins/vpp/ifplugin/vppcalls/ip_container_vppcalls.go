...
func sendAndLogMessageForVpp(ifIdx uint32, addr string, isAdd uint8, vppChan govppapi.VPPChannel, stopwatch *measure.Stopwatch) error {
...
func AddContainerIP(ifIdx uint32, addr string, vppChan govppapi.VPPChannel, stopwatch *measure.Stopwatch) error {
...
func DelContainerIP(ifIdx uint32, addr string, vppChan govppapi.VPPChannel, stopwatch *measure.Stopwatch) error {
