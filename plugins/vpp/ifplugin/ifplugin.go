...
//go:generate descriptor-adapter --descriptor-name Interface  --value-type *vpp_interfaces.Interface --meta-type *ifaceidx.IfaceMetadata --import "go.ligato.io/vpp-agent/v2/plugins/vpp/ifplugin/ifaceidx" --import "go.ligato.io/vpp-agent/v2/proto/ligato/vpp-agent/vpp/interfaces" --output-dir "descriptor"
//go:generate descriptor-adapter --descriptor-name Unnumbered  --value-type *vpp_interfaces.Interface_Unnumbered --import "go.ligato.io/vpp-agent/v2/proto/ligato/vpp-agent/vpp/interfaces" --output-dir "descriptor"
//go:generate descriptor-adapter --descriptor-name RxMode  --value-type *vpp_interfaces.Interface --import "go.ligato.io/vpp-agent/v2/proto/ligato/vpp-agent/vpp/interfaces" --output-dir "descriptor"
//go:generate descriptor-adapter --descriptor-name RxPlacement  --value-type *vpp_interfaces.Interface_RxPlacement --import "go.ligato.io/vpp-agent/v2/proto/ligato/vpp-agent/vpp/interfaces" --output-dir "descriptor"
//go:generate descriptor-adapter --descriptor-name BondedInterface  --value-type *vpp_interfaces.BondLink_BondedInterface --import "go.ligato.io/vpp-agent/v2/proto/ligato/vpp-agent/vpp/interfaces" --output-dir "descriptor"
//go:generate descriptor-adapter --descriptor-name Span  --value-type *vpp_interfaces.Span --import "go.ligato.io/vpp-agent/v2/proto/ligato/vpp-agent/vpp/interfaces" --output-dir "descriptor"
...
// Cast metadata to "go.ligato.io/vpp-agent/v2/proto/ligato/vpp-agent/vpp/interfaces".DHCPLease
