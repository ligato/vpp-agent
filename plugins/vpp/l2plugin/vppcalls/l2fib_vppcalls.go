...
func NewL2FibVppCalls(log logging.Logger, vppChan govppapi.VPPChannel, stopwatch *measure.Stopwatch) *L2FibVppCalls {
...
func l2fibAddDel(macstr string, bdIdx, swIfIdx uint32, bvi, static, isAdd bool, vppChan govppapi.VPPChannel, stopwatch *measure.Stopwatch) (err error) {
