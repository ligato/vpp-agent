...
import (
	...
	"github.com/ligato/vpp-agent/plugins/vpp/l2plugin/vppcalls/vpp2001_379"

	l2 "github.com/ligato/vpp-agent/api/models/vpp/l2"
	"github.com/ligato/vpp-agent/pkg/idxvpp"
	vpp_l2 "github.com/ligato/vpp-agent/plugins/vpp/binapi/vpp2001_379/l2"
...
func fibTestSetup(t *testing.T) (*vppcallmock.TestCtx, vppcalls.FIBVppAPI, ifaceidx.IfaceMetadataIndexRW, idxvpp.NameToIndexRW) {
	...
	fibHandler := vpp2001_379.NewL2VppHandler(ctx.MockChannel, ifaceIdx, bdIndexes, logger)
