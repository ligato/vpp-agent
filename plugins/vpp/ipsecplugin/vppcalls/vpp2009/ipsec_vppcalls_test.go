...
import (
	...
	vpp2009 "go.ligato.io/vpp-agent/v3/plugins/vpp/ipsecplugin/vppcalls/vpp2009"
	"go.ligato.io/vpp-agent/v3/plugins/vpp/vppmock"
	ipsec "go.ligato.io/vpp-agent/v3/proto/ligato/vpp/ipsec"
)

func ipToAddr(ip string) vpp_ipsec.Address {
	addr, err := vpp2009.IPToAddress(ip)
	if err != nil {
...
func ipSecTestSetup(t *testing.T) (*vppmock.TestCtx, vppcalls.IPSecVppAPI, ifaceidx.IfaceMetadataIndexRW) {
	...
	ipSecHandler := vpp2009.NewIPSecVppHandler(ctx.MockChannel, ifIndex, log)
