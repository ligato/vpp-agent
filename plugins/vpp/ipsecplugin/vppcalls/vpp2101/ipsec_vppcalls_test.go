...
import (
	...
	"go.ligato.io/vpp-agent/v3/plugins/vpp/ipsecplugin/vppcalls/vpp2101"
	"go.ligato.io/vpp-agent/v3/plugins/vpp/vppmock"
	ipsec "go.ligato.io/vpp-agent/v3/proto/ligato/vpp/ipsec"
)

func ipToAddr(ip string) ip_types.Address {
	addr, err := vpp2101.IPToAddress(ip)
	if err != nil {
...
func ipSecTestSetup(t *testing.T) (*vppmock.TestCtx, vppcalls.IPSecVppAPI, ifaceidx.IfaceMetadataIndexRW) {
	...
	ipSecHandler := vpp2101.NewIPSecVppHandler(ctx.MockChannel, ifIndex, log)
