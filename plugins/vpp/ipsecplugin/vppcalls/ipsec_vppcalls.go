...
func tunnelIfAddDel(tunnel *ipsec.TunnelInterfaces_Tunnel, isAdd bool, vppChan govppapi.VPPChannel, stopwatch *measure.Stopwatch) (uint32, error) {
...
func AddTunnelInterface(tunnel *ipsec.TunnelInterfaces_Tunnel, vppChan govppapi.VPPChannel, stopwatch *measure.Stopwatch) (uint32, error) {
	return tunnelIfAddDel(tunnel, true, vppChan, stopwatch)
}

// DelSPD deletes SPD from VPP via binary API
func DelTunnelInterface(ifIdx uint32, tunnel *ipsec.TunnelInterfaces_Tunnel, vppChan govppapi.VPPChannel, stopwatch *measure.Stopwatch) error {
...
func spdAddDel(spdID uint32, isAdd bool, vppChan govppapi.VPPChannel, stopwatch *measure.Stopwatch) error {
	defer func(t time.Time) {
...
// AddSPD adds SPD to VPP via binary API
func AddSPD(spdID uint32, vppChan govppapi.VPPChannel, stopwatch *measure.Stopwatch) error {
	return spdAddDel(spdID, true, vppChan, stopwatch)
}

// DelSPD deletes SPD from VPP via binary API
func DelSPD(spdID uint32, vppChan govppapi.VPPChannel, stopwatch *measure.Stopwatch) error {
	return spdAddDel(spdID, false, vppChan, stopwatch)
}

func interfaceAddDelSpd(spdID, swIfIdx uint32, isAdd bool, vppChan govppapi.VPPChannel, stopwatch *measure.Stopwatch) error {
	defer func(t time.Time) {
...
func InterfaceAddSPD(spdID, swIfIdx uint32, vppChan govppapi.VPPChannel, stopwatch *measure.Stopwatch) error {
...
func InterfaceDelSPD(spdID, swIfIdx uint32, vppChan govppapi.VPPChannel, stopwatch *measure.Stopwatch) error {
	return interfaceAddDelSpd(spdID, swIfIdx, false, vppChan, stopwatch)
}

func spdAddDelEntry(spdID, saID uint32, spd *ipsec.SecurityPolicyDatabases_SPD_PolicyEntry, isAdd bool, vppChan govppapi.VPPChannel, stopwatch *measure.Stopwatch) error {
	defer func(t time.Time) {
...
func AddSPDEntry(spdID, saID uint32, spd *ipsec.SecurityPolicyDatabases_SPD_PolicyEntry, vppChan govppapi.VPPChannel, stopwatch *measure.Stopwatch) error {
	return spdAddDelEntry(spdID, saID, spd, true, vppChan, stopwatch)
}

// DelSPDEntry deletes SPD policy entry from VPP via binary API
func DelSPDEntry(spdID, saID uint32, spd *ipsec.SecurityPolicyDatabases_SPD_PolicyEntry, vppChan govppapi.VPPChannel, stopwatch *measure.Stopwatch) error {
	return spdAddDelEntry(spdID, saID, spd, false, vppChan, stopwatch)
}

func sadAddDelEntry(saID uint32, sa *ipsec.SecurityAssociations_SA, isAdd bool, vppChan govppapi.VPPChannel, stopwatch *measure.Stopwatch) error {
	defer func(t time.Time) {
...
func AddSAEntry(saID uint32, sa *ipsec.SecurityAssociations_SA, vppChan govppapi.VPPChannel, stopwatch *measure.Stopwatch) error {
	return sadAddDelEntry(saID, sa, true, vppChan, stopwatch)
}

// DelSAEntry deletes SA from VPP via binary API
func DelSAEntry(saID uint32, sa *ipsec.SecurityAssociations_SA, vppChan govppapi.VPPChannel, stopwatch *measure.Stopwatch) error {
