...
import (
	...
	"github.com/ligato/vpp-agent/plugins/vpp/ipsecplugin/vppcalls/vpp2001_324"
	"github.com/ligato/vpp-agent/plugins/vpp/vppcallmock"
	. "github.com/onsi/gomega"
)

func ipToAddr(ip string) vpp_ipsec.Address {
	addr, err := vpp2001_324.IPToAddress(ip)
	if err != nil {
...
func ipSecTestSetup(t *testing.T) (*vppcallmock.TestCtx, vppcalls.IPSecVppAPI, ifaceidx.IfaceMetadataIndexRW) {
	...
	ipSecHandler := vpp2001_324.NewIPSecVppHandler(ctx.MockChannel, ifIndex, log)
