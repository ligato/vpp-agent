...
type IPFIXDescriptorAdapter struct {
	descriptor *IPFIXDescriptor
}

func NewIPFIXDescriptor(typedDescriptor *IPFIXDescriptor) *KVDescriptor {
	adapter := &IPFIXDescriptorAdapter{descriptor: typedDescriptor}
...
func (da *IPFIXDescriptorAdapter) ValueComparator(key string, oldValue, newValue proto.Message) bool {
	typedOldValue, err1 := castIPFIXValue(key, oldValue)
	typedNewValue, err2 := castIPFIXValue(key, newValue)
...
func (da *IPFIXDescriptorAdapter) Validate(key string, value proto.Message) (err error) {
	typedValue, err := castIPFIXValue(key, value)
	if err != nil {
		return err
	}
...
func (da *IPFIXDescriptorAdapter) Update(key string, oldValue, newValue proto.Message, oldMetadata Metadata) (newMetadata Metadata, err error) {
	oldTypedValue, err := castIPFIXValue(key, oldValue)
	if err != nil {
		return nil, err
	}
	newTypedValue, err := castIPFIXValue(key, newValue)
	if err != nil {
		return nil, err
	}
	typedOldMetadata, err := castIPFIXMetadata(key, oldMetadata)
	if err != nil {
		return nil, err
	}
...
func (da *IPFIXDescriptorAdapter) Delete(key string, value proto.Message, metadata Metadata) error {
	...
	typedMetadata, err := castIPFIXMetadata(key, metadata)
	if err != nil {
		return err
	}
...
func (da *IPFIXDescriptorAdapter) Retrieve(correlate []KVWithMetadata) ([]KVWithMetadata, error) {
	var correlateWithType []IPFIXKVWithMetadata
	for _, kvpair := range correlate {
		typedValue, err := castIPFIXValue(kvpair.Key, kvpair.Value)
		if err != nil {
			continue
		}
		typedMetadata, err := castIPFIXMetadata(kvpair.Key, kvpair.Metadata)
		if err != nil {
			continue
		}
...
func castIPFIXValue(key string, value proto.Message) (*vpp_ipfix.IPFIX, error) {
	typedValue, ok := value.(*vpp_ipfix.IPFIX)
	if !ok {
...
func castIPFIXMetadata(key string, metadata Metadata) (interface{}, error) {
	if metadata == nil {
		return nil, nil
	}
