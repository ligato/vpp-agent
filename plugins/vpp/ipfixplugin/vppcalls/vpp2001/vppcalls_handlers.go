...
import (
	...
	vpp_fp "go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2001/flowprobe"
	vpp_ipfix "go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2001/ipfix_export"
...
func init() {
	...
	vppcalls.AddIpfixHandlerVersion(vpp2001.Version, msgs, NewIpfixVppHandler)
}
