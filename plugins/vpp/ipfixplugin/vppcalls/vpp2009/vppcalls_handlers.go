...
import (
	...
	vpp_fp "go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2009/flowprobe"
	vpp_ipfix "go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2009/ipfix_export"
...
func init() {
	...
	vppcalls.AddIpfixHandlerVersion(vpp2009.Version, msgs, NewIpfixVppHandler)
}
