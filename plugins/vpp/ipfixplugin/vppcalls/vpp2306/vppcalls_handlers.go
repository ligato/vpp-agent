...
import (
	...
	vpp_fp "go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2306/flowprobe"
	vpp_ipfix "go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2306/ipfix_export"
...
func init() {
	...
	vppcalls.AddIpfixHandlerVersion(vpp2306.Version, msgs, NewIpfixVppHandler)
}
