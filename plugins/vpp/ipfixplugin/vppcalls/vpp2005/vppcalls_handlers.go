...
import (
	...
	vpp_fp "go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2005/flowprobe"
	vpp_ipfix "go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2005/ipfix_export"
...
func init() {
	...
	vppcalls.AddIpfixHandlerVersion(vpp2005.Version, msgs, NewIpfixVppHandler)
}
