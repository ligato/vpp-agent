...
import (
	...
	vpp_fp "go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2101/flowprobe"
	vpp_ipfix "go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2101/ipfix_export"
...
func init() {
	...
	vppcalls.AddIpfixHandlerVersion(vpp2101.Version, msgs, NewIpfixVppHandler)
}
