...
import (
	...
	vpp_punt "go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2009/punt"
	"go.ligato.io/vpp-agent/v3/plugins/vpp/ifplugin/ifaceidx"
	"go.ligato.io/vpp-agent/v3/plugins/vpp/puntplugin/vppcalls"
	vpp2009 "go.ligato.io/vpp-agent/v3/plugins/vpp/puntplugin/vppcalls/vpp2009"
...
func puntTestSetup(t *testing.T) (*vppmock.TestCtx, vppcalls.PuntVppAPI, ifaceidx.IfaceMetadataIndexRW) {
	...
	puntHandler := vpp2009.NewPuntVppHandler(ctx.MockChannel, ifIndexes, logrus.DefaultLogger())
