...
import (
	...
	vpp_punt "go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2005/punt"
	"go.ligato.io/vpp-agent/v3/plugins/vpp/ifplugin/ifaceidx"
	"go.ligato.io/vpp-agent/v3/plugins/vpp/puntplugin/vppcalls"
	"go.ligato.io/vpp-agent/v3/plugins/vpp/puntplugin/vppcalls/vpp2005"
...
func puntTestSetup(t *testing.T) (*vppmock.TestCtx, vppcalls.PuntVppAPI, ifaceidx.IfaceMetadataIndexRW) {
	...
	puntHandler := vpp2005.NewPuntVppHandler(ctx.MockChannel, ifIndexes, logrus.DefaultLogger())
