...
import (
	...
	vpp2106 "go.ligato.io/vpp-agent/v3/plugins/vpp/puntplugin/vppcalls/vpp2106"
...
func puntTestSetup(t *testing.T) (*vppmock.TestCtx, vppcalls.PuntVppAPI, ifaceidx.IfaceMetadataIndexRW) {
	...
	puntHandler := vpp2106.NewPuntVppHandler(ctx.MockChannel, ifIndexes, logrus.DefaultLogger())
