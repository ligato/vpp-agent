...
import (
	...
	vpp_punt "github.com/ligato/vpp-agent/plugins/vpp/binapi/vpp2001_379/punt"
	"github.com/ligato/vpp-agent/plugins/vpp/ifplugin/ifaceidx"
	"github.com/ligato/vpp-agent/plugins/vpp/puntplugin/vppcalls"
	"github.com/ligato/vpp-agent/plugins/vpp/puntplugin/vppcalls/vpp2001_379"
...
func puntTestSetup(t *testing.T) (*vppcallmock.TestCtx, vppcalls.PuntVppAPI, ifaceidx.IfaceMetadataIndexRW) {
	...
	puntHandler := vpp2001_379.NewPuntVppHandler(ctx.MockChannel, ifIndexes, logrus.DefaultLogger())
