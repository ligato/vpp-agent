...
import (
	...
	vpp2101 "go.ligato.io/vpp-agent/v3/plugins/vpp/puntplugin/vppcalls/vpp2101"
...
func puntTestSetup(t *testing.T) (*vppmock.TestCtx, vppcalls.PuntVppAPI, ifaceidx.IfaceMetadataIndexRW) {
	...
	puntHandler := vpp2101.NewPuntVppHandler(ctx.MockChannel, ifIndexes, logrus.DefaultLogger())
