...
import (
	...
	vpp_stn "go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2101/stn"
	"go.ligato.io/vpp-agent/v3/plugins/vpp/ifplugin/ifaceidx"
	"go.ligato.io/vpp-agent/v3/plugins/vpp/stnplugin/vppcalls"
	vpp2101 "go.ligato.io/vpp-agent/v3/plugins/vpp/stnplugin/vppcalls/vpp2101"
...
func stnTestSetup(t *testing.T) (*vppmock.TestCtx, vppcalls.StnVppAPI, ifaceidx.IfaceMetadataIndexRW) {
	...
	stnHandler := vpp2101.NewStnVppHandler(ctx.MockChannel, ifIndexes, logrus.DefaultLogger())
