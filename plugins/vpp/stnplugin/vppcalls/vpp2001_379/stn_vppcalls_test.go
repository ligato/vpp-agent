...
import (
	...
	vpp_stn "github.com/ligato/vpp-agent/plugins/vpp/binapi/vpp2001_379/stn"
	"github.com/ligato/vpp-agent/plugins/vpp/ifplugin/ifaceidx"
	"github.com/ligato/vpp-agent/plugins/vpp/stnplugin/vppcalls"
	"github.com/ligato/vpp-agent/plugins/vpp/stnplugin/vppcalls/vpp2001_379"
...
func stnTestSetup(t *testing.T) (*vppcallmock.TestCtx, vppcalls.StnVppAPI, ifaceidx.IfaceMetadataIndexRW) {
	...
	stnHandler := vpp2001_379.NewStnVppHandler(ctx.MockChannel, ifIndexes, logrus.DefaultLogger())
