...
import (
	...
	vpp2106 "go.ligato.io/vpp-agent/v3/plugins/vpp/stnplugin/vppcalls/vpp2106"
...
func stnTestSetup(t *testing.T) (*vppmock.TestCtx, vppcalls.StnVppAPI, ifaceidx.IfaceMetadataIndexRW) {
	...
	stnHandler := vpp2106.NewStnVppHandler(ctx.MockChannel, ifIndexes, logrus.DefaultLogger())
