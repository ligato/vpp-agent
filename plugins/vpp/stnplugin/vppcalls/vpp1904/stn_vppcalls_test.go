...
import (
	...
	api "github.com/ligato/vpp-agent/plugins/vpp/binapi/vpp1904/stn"
	"github.com/ligato/vpp-agent/plugins/vpp/ifplugin/ifaceidx"
	"github.com/ligato/vpp-agent/plugins/vpp/stnplugin/vppcalls"
	"github.com/ligato/vpp-agent/plugins/vpp/stnplugin/vppcalls/vpp1904"
...
func stnTestSetup(t *testing.T) (*vppcallmock.TestCtx, vppcalls.StnVppAPI, ifaceidx.IfaceMetadataIndexRW) {
	...
	stnHandler := vpp1904.NewStnVppHandler(ctx.MockChannel, ifIndexes, logrus.DefaultLogger())
