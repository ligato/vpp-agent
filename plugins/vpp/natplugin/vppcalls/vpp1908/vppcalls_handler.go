...
func init() {
	...
	vppcalls.AddNatHandlerVersion(vpp1908.Version, msgs, func(c vpp.Client, ifIdx ifaceidx.IfaceMetadataIndex, dhcpIdx idxmap.NamedMapping, log logging.Logger) vppcalls.NatVppAPI {
