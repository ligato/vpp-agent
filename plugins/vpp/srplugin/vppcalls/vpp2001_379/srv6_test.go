...
import (
	...
	vpp_sr "github.com/ligato/vpp-agent/plugins/vpp/binapi/vpp2001_379/sr"
	...
	"github.com/ligato/vpp-agent/plugins/vpp/srplugin/vppcalls/vpp2001_379"
	...
	cases := []struct {
	...
	}{
		{
			...
			Expected: &vpp_sr.SrLocalsidAddDel{
				IsDel:    0,
				Localsid: sidA,
				Behavior: vpp2001_379.BehaviorEnd,
		...
		},
		{
			...
			Expected: &vpp_sr.SrLocalsidAddDel{
				IsDel:     0,
				Localsid:  sidA,
				Behavior:  vpp2001_379.BehaviorX,
				FibTable:  10, // installationVrfId
				EndPsp:    1,
				SwIfIndex: swIndexA,
				NhAddr6:   nextHop,
		...
		},
		{
			...
			Expected: &vpp_sr.SrLocalsidAddDel{
				IsDel:     0,
				Localsid:  sidA,
				Behavior:  vpp2001_379.BehaviorT,
				FibTable:  10, // installationVrfId
				SwIfIndex: 11,
				EndPsp:    1,
			},
		},
		{
			...
			Expected: &vpp_sr.SrLocalsidAddDel{
				IsDel:     0,
				Localsid:  sidA,
				Behavior:  vpp2001_379.BehaviorDX2,
				FibTable:  10, // installationVrfId
				EndPsp:    0,
				VlanIndex: 1,
				SwIfIndex: swIndexA,
		...
		},
		{
			...
			Expected: &vpp_sr.SrLocalsidAddDel{
				IsDel:     0,
				Localsid:  sidA,
				Behavior:  vpp2001_379.BehaviorDX4,
				FibTable:  10, // installationVrfId
				EndPsp:    0,
				SwIfIndex: swIndexA,
				NhAddr4:   nextHopIPv4,
		...
		},
		{
			...
			Expected: &vpp_sr.SrLocalsidAddDel{
				IsDel:     0,
				Localsid:  sidA,
				Behavior:  vpp2001_379.BehaviorDX6,
				FibTable:  10, // installationVrfId
				EndPsp:    0,
				SwIfIndex: swIndexA,
				NhAddr6:   nextHop,
		...
		},
		{
			...
			Expected: &vpp_sr.SrLocalsidAddDel{
				IsDel:     0,
				Localsid:  sidA,
				Behavior:  vpp2001_379.BehaviorDT4,
				FibTable:  10, // installationVrfId
				SwIfIndex: 5,
				EndPsp:    0,
			},
		},
		{
			...
			Expected: &vpp_sr.SrLocalsidAddDel{
				IsDel:     0,
				Localsid:  sidA,
				Behavior:  vpp2001_379.BehaviorDT6,
				FibTable:  10, // installationVrfId
				SwIfIndex: 5,
				EndPsp:    0,
			},
		...
		},
		{
			...
			Verify: func(err error, catchedMsgs []govppapi.Message) {
				...
				Expect(catchedMsgs[1]).To(Equal(&vpp_sr.SrPolicyMod{
					BsidAddr:  sidA.Addr,
					Operation: vpp2001_379.AddSRList,
					FibTable:  10, // installationVrfId
					Sids: vpp_sr.Srv6SidList{
						Weight:  1,
						NumSids: 3,
	...
	cases := []struct {
	...
	}{
		{
			...
			Verify: func(err error, catchedMsg govppapi.Message) {
				...
				Expect(catchedMsg).To(Equal(&vpp_sr.SrPolicyMod{
					BsidAddr:  sidA.Addr,
					Operation: vpp2001_379.DeleteSRList,
					SlIndex:   111,
					FibTable:  10, // installationVrfId
					Sids: vpp_sr.Srv6SidList{
						Weight:  1,
	...
	}{
		{
			...
			Verify: func(err error, catchedMsg govppapi.Message) {
				...
				Expect(catchedMsg).To(Equal(&vpp_sr.SrSteeringAddDel{
					...
					TableID:       10,
					TrafficType:   vpp2001_379.SteerTypeIPv6,
		...
		},
		{
			...
			Verify: func(err error, catchedMsg govppapi.Message) {
				...
				Expect(catchedMsg).To(Equal(&vpp_sr.SrSteeringAddDel{
					...
					SrPolicyIndex: uint32(0),
					TableID:       10,
					TrafficType:   vpp2001_379.SteerTypeIPv4,
		...
		},
		{
			...
			Verify: func(err error, catchedMsg govppapi.Message) {
				...
				Expect(catchedMsg).To(Equal(&vpp_sr.SrSteeringAddDel{
					...
					BsidAddr:      sidA.Addr,
					SrPolicyIndex: uint32(0),
					TrafficType:   vpp2001_379.SteerTypeL2,
					SwIfIndex:     swIndexA,
				}))
			},
		},
...
func setup(t *testing.T) (*vppcallmock.TestCtx, vppcalls.SRv6VppAPI) {
	...
	vppCalls := vpp2001_379.NewSRv6VppHandler(ctx.MockChannel, swIfIndex, log)
	return ctx, vppCalls
}
