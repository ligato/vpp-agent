...
import (
	...
	core_vpp2005 "go.ligato.io/vpp-agent/v3/plugins/govppmux/vppcalls/vpp2005"
...
func init() {
	...
	vppcalls.AddHandlerVersion(vpp2005.Version, msgs.AllMessages(), NewSRv6VppHandler)
}
...
func NewSRv6VppHandler(c vpp.Client, ifIdx ifaceidx.IfaceMetadataIndex, log logging.Logger) vppcalls.SRv6VppAPI {
	...
	return &SRv6VppHandler{
		...
		ifIndexes:    ifIdx,
		log:          log,
		VppCoreAPI:   core_vpp2005.NewVpeHandler(vppChan),
	}
}
