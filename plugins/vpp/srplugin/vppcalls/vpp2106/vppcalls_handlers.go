...
import (
	...
	core_vpp2106 "go.ligato.io/vpp-agent/v3/plugins/govppmux/vppcalls/vpp2106"
...
func init() {
	...
	vppcalls.AddHandlerVersion(vpp2106.Version, msgs.AllMessages(), NewSRv6VppHandler)
}
...
func NewSRv6VppHandler(c vpp.Client, ifIdx ifaceidx.IfaceMetadataIndex, log logging.Logger) vppcalls.SRv6VppAPI {
	...
	return &SRv6VppHandler{
		...
		ifIndexes:    ifIdx,
		log:          log,
		VppCoreAPI:   core_vpp2106.NewVpeHandler(c),
	}
}
