...
import (
	...
	core_vpp2306 "go.ligato.io/vpp-agent/v3/plugins/govppmux/vppcalls/vpp2306"
...
func init() {
	...
	vppcalls.AddHandlerVersion(vpp2306.Version, msgs.AllMessages(), NewSRv6VppHandler)
}
...
func NewSRv6VppHandler(c vpp.Client, ifIdx ifaceidx.IfaceMetadataIndex, log logging.Logger) vppcalls.SRv6VppAPI {
	...
	return &SRv6VppHandler{
		...
		ifIndexes:    ifIdx,
		log:          log,
		VppCoreAPI:   core_vpp2306.NewVpeHandler(c),
	}
}
