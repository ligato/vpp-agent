...
// Package vpp2306 contains wrappers over VPP binary APIs to simplify their usage
package vpp2306
...
import (
	...
	"go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2306/sr_types"
...
func (h *SRv6VppHandler) addDelSteering(delete bool, steering *srv6.Steering) error {
	...
	case *srv6.Steering_L3Traffic_:
		...
		prefix.Address, _ = vpp2306.IPToAddress(ip.String())
