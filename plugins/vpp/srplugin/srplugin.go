...
//go:generate descriptor-adapter --descriptor-name EncapSourceAddress --value-type *vpp_srv6.EncapSourceAddress --import "go.ligato.io/vpp-agent/v2/proto/ligato/vpp/srv6" --output-dir "descriptor"
