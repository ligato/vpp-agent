...
//go:generate -command binapigentypes binapi-generator --output-dir=. --import-prefix=go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2005/
...
//go:generate -command binapigen binapi-generator --output-dir=. --import-prefix=go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2005/ --input-types=$VPP_API_DIR/core/ethernet_types.api.json,$VPP_API_DIR/core/interface_types.api.json,$VPP_API_DIR/core/ip_types.api.json,$VPP_API_DIR/core/fib_types.api.json,$VPP_API_DIR/core/ipsec_types.api.json,$VPP_API_DIR/core/vpe_types.api.json
