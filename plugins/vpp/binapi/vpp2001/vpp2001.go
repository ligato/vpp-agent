...
//go:generate binapi-generator --output-dir=. --input-file=$VPP_API_DIR/core/fib_types.api.json
...
//go:generate -command binapigen binapi-generator --output-dir=. --input-types=$VPP_API_DIR/core/ethernet_types.api.json,$VPP_API_DIR/core/fib_types.api.json,$VPP_API_DIR/core/interface_types.api.json,$VPP_API_DIR/core/ip_types.api.json,$VPP_API_DIR/core/vpe_types.api.json
