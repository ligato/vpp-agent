...
type RPCService interface {
	...
	ConnectSession(ctx context.Context, in *ConnectSession) (*ConnectSessionReply, error)
...
func (c *serviceClient) ConnectSession(ctx context.Context, in *ConnectSession) (*ConnectSessionReply, error) {
	out := new(ConnectSessionReply)
	err := c.ch.SendRequest(in).ReceiveReply(out)
	if err != nil {
		return nil, err
	}
