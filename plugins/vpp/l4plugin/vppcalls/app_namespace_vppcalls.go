...
func AddAppNamespace(secret uint64, swIfIdx, ip4FibID, ip6FibID uint32, id []byte, vppChan govppapi.VPPChannel, stopwatch *measure.Stopwatch) (appNsIdx uint32, err error) {
