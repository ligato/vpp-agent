...
import (
	...
	"go.ligato.io/vpp-agent/v3/plugins/vpp/l3plugin/vppcalls/vpp2009"
...
var vrrpEntries = []*l3.VRRPEntry{
	{
		...
		Accept:     false,
		Unicast:    false,
		IpAdresses: []string{"192.168.10.21"},
		Enabled:    true,
	},
	{
		Interface:  "if1",
		...
		Accept:     false,
		Unicast:    false,
		IpAdresses: []string{"192.168.10.22", "192.168.10.23"},
		Enabled:    false,
	},
	{
		Interface:  "if1",
...
func vrrpTestSetup(t *testing.T) (*vppmock.TestCtx, ifaceidx.IfaceMetadataIndexRW, vppcalls.VrrpVppAPI) {
	...
	vrrpHandler := vpp2009.NewVrrpVppHandler(ctx.MockChannel, ifIndexes, log)
