...
func NewL3VppHandler(ch govppapi.Channel, ifIdx ifaceidx.IfaceMetadataIndex, log logging.Logger) L3VppAPI {
	return &L3VppHandler{
...
func NewIPNeighVppHandler(callsChan govppapi.Channel, log logging.Logger) *IPNeighHandler {
	...
	return &IPNeighHandler{
		callsChannel: callsChan,
		log:          log,
		VpeVppAPI:    vppcalls.CompatibleVpeHandler(callsChan),
	}
}
