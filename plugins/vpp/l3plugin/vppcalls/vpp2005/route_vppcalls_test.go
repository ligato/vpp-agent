...
import (
	...
	ifvpp2005_379 "go.ligato.io/vpp-agent/v3/plugins/vpp/ifplugin/vppcalls/vpp2005"
...
func routeTestSetup(t *testing.T) (*vppmock.TestCtx, ifvppcalls.InterfaceVppAPI, vppcalls.RouteVppAPI) {
	...
	ifHandler := ifvpp2005_379.NewInterfaceVppHandler(ctx.MockVPPClient, log)
	...
	rtHandler := vpp2005.NewRouteVppHandler(ctx.MockChannel, ifIndexes, vrfIndexes, netallock_mock.NewMockNetAlloc(), log)
