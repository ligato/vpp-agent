...
import (
	...
	vpp_ip_neighbor "go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2101/ip_neighbor"
...
func init() {
	...
	vppcalls.AddHandlerVersion(vpp2101.Version, msgs, NewL3VppHandler)
}
...
func NewIPNeighVppHandler(c vpp.Client, callsChan govppapi.Channel, log logging.Logger) *IPNeighHandler {
	...
	return &IPNeighHandler{
		callsChannel: callsChan,
		log:          log,
		VppCoreAPI:   vpe_vpp2101.NewVpeHandler(c),
	}
}
