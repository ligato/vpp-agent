...
import (
	...
	"go.ligato.io/vpp-agent/v3/plugins/vpp/binapi/vpp2101/vrrp"
	"go.ligato.io/vpp-agent/v3/plugins/vpp/ifplugin/ifaceidx"
	"go.ligato.io/vpp-agent/v3/plugins/vpp/l3plugin/vppcalls"
	"go.ligato.io/vpp-agent/v3/plugins/vpp/l3plugin/vppcalls/vpp2101"
...
func vrrpTestSetup(t *testing.T) (*vppmock.TestCtx, ifaceidx.IfaceMetadataIndexRW, vppcalls.VrrpVppAPI) {
	...
	vrrpHandler := vpp2101.NewVrrpVppHandler(ctx.MockChannel, ifIndexes, log)
