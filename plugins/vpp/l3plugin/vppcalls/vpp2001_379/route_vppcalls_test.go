...
import (
	...
	ifvpp2001_379 "github.com/ligato/vpp-agent/plugins/vpp/ifplugin/vppcalls/vpp2001_379"
	"github.com/ligato/vpp-agent/plugins/vpp/l3plugin/vppcalls"
	"github.com/ligato/vpp-agent/plugins/vpp/l3plugin/vppcalls/vpp2001_379"
...
func routeTestSetup(t *testing.T) (*vppcallmock.TestCtx, ifvppcalls.InterfaceVppAPI, vppcalls.RouteVppAPI) {
	...
	ifHandler := ifvpp2001_379.NewInterfaceVppHandler(ctx.MockChannel, log)
	...
	rtHandler := vpp2001_379.NewRouteVppHandler(ctx.MockChannel, ifIndexes, vrfIndexes, netallock_mock.NewMockNetAlloc(), log)
