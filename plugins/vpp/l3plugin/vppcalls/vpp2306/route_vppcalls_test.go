...
import (
	...
	ifvpp2306 "go.ligato.io/vpp-agent/v3/plugins/vpp/ifplugin/vppcalls/vpp2306"
	"go.ligato.io/vpp-agent/v3/plugins/vpp/l3plugin/vppcalls"
	vpp2306 "go.ligato.io/vpp-agent/v3/plugins/vpp/l3plugin/vppcalls/vpp2306"
...
func routeTestSetup(t *testing.T) (*vppmock.TestCtx, ifvppcalls.InterfaceVppAPI, vppcalls.RouteVppAPI) {
	...
	ifHandler := ifvpp2306.NewInterfaceVppHandler(ctx.MockVPPClient, log)
	...
	rtHandler := vpp2306.NewRouteVppHandler(ctx.MockChannel, ifIndexes, vrfIndexes, netallock_mock.NewMockNetAlloc(), log)
