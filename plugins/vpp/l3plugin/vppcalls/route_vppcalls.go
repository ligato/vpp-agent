...
func vppAddDelRoute(route *Route, vppChan govppapi.VPPChannel, delete bool, stopwatch *measure.Stopwatch) error {
...
func VppAddRoute(route *Route, vppChan govppapi.VPPChannel, stopwatch *measure.Stopwatch) error {
...
func VppDelRoute(route *Route, vppChan govppapi.VPPChannel, stopwatch *measure.Stopwatch) error {
