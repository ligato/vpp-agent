...
// VppAddVrrp implements VRRP handler (not supported in VPP 20.01).
func (h *VrrpVppHandler) VppAddVrrp(entry *l3.VRRPEntry) error {
	return fmt.Errorf("%w in VPP 20.01", vppcalls.ErrVRRPUnsupported)
}

// VppDelVrrp implements VRRP handler (not supported in VPP 20.01).
