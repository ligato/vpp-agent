...
import (
	...
	ifvpp2106_379 "go.ligato.io/vpp-agent/v3/plugins/vpp/ifplugin/vppcalls/vpp2106"
...
func routeTestSetup(t *testing.T) (*vppmock.TestCtx, ifvppcalls.InterfaceVppAPI, vppcalls.RouteVppAPI) {
	...
	ifHandler := ifvpp2106_379.NewInterfaceVppHandler(ctx.MockVPPClient, log)
	...
	rtHandler := vpp2106.NewRouteVppHandler(ctx.MockChannel, ifIndexes, vrfIndexes, netallock_mock.NewMockNetAlloc(), log)
