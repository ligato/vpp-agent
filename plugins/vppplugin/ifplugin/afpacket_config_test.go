...
import (
	...
	ap_api "github.com/ligato/vpp-agent/plugins/vppplugin/generated/bin_api/af_packet"
	if_api "github.com/ligato/vpp-agent/plugins/vppplugin/generated/bin_api/interfaces"
	"github.com/ligato/vpp-agent/plugins/vppplugin/generated/model/interfaces"
	"github.com/ligato/vpp-agent/plugins/vppplugin/ifplugin"
...
func TestAfPacketConfiguratorInit(t *testing.T) {
	...
	Expect(err).To(BeNil())
	err = plugin.Init(logrus.DefaultLogger(), vppCh, struct{}{}, nil, nil)
	Expect(err).To(BeNil())
