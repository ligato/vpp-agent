...
func CheckMsgCompatibilityForACL(log logging.Logger, vppChannel vppdump.VPPChannel) error {
	msgs := []govppapi.Message{
		...
		&acl.MacipACLAddReplace{},
		&acl.MacipACLAddReplaceReply{},
		&acl.MacipACLDel{},
		...
		&acl.MacipACLInterfaceListDump{},
		&acl.MacipACLInterfaceListDetails{},
