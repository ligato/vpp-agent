...
//go:generate descriptor-adapter --descriptor-name ARP --value-type *linux_l3.StaticARPEntry --import "github.com/ligato/vpp-agent/api/models/linux/l3" --output-dir "descriptor"
//go:generate descriptor-adapter --descriptor-name Route --value-type *linux_l3.StaticRoute --import "github.com/ligato/vpp-agent/api/models/linux/l3" --output-dir "descriptor"
