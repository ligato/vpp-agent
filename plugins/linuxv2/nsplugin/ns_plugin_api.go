...
type API interface {
	...
	SwitchToNamespace(ctx linuxcalls.NamespaceMgmtCtx, ns *namespace.Namespace) (revert func(), err error)
	...
	GetNamespaceHandle(ctx linuxcalls.NamespaceMgmtCtx, ns *namespace.Namespace) (handle netns.NsHandle, err error)
}
