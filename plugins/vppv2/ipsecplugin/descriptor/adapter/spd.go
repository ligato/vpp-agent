...
type SPDDescriptor struct {
	...
	Create               func(key string, value *vpp_ipsec.SecurityPolicyDatabase) (metadata *idxvpp2.OnlyIndex, err error)
	Delete               func(key string, value *vpp_ipsec.SecurityPolicyDatabase, metadata *idxvpp2.OnlyIndex) error
	Update               func(key string, oldValue, newValue *vpp_ipsec.SecurityPolicyDatabase, oldMetadata *idxvpp2.OnlyIndex) (newMetadata *idxvpp2.OnlyIndex, err error)
	UpdateWithRecreate   func(key string, oldValue, newValue *vpp_ipsec.SecurityPolicyDatabase, metadata *idxvpp2.OnlyIndex) bool
