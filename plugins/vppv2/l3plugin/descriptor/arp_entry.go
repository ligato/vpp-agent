...
func (d *ArpDescriptor) GetDescriptor() *adapter.ARPEntryDescriptor {
	return &adapter.ARPEntryDescriptor{
		...
		NBKeyPrefix:     vpp.ARPEntrySpec.KeyPrefix(),
		ValueTypeName:   vpp.ARPEntrySpec.ProtoName(),
		KeySelector:     vpp.ARPEntrySpec.IsKeyValid,
		KeyLabel:        vpp.ARPEntrySpec.StripKeyPrefix,
