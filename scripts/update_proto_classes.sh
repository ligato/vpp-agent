...
mkdir pout
protoc --proto_path=vendor --proto_path=api --python_out=pout api/models/vpp/interfaces/interface.proto vendor/github.com/gogo/protobuf/gogoproto/gogo.proto api/models/vpp/ipsec/ipsec.proto api/models/vpp/l3/route.proto api/models/vpp/l2/bridge-domain.proto api/models/vpp/nat/nat.proto api/models/vpp/l2/xconnect.proto api/models/vpp/l3/l3.proto api/models/linux/interfaces/interface.proto  api/models/linux/namespace/namespace.proto
