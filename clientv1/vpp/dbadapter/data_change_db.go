...
func (dsl *PutDSL) Arp(arp *l3.ArpTable_ArpEntry) vppplugin.PutDSL {
...
func (dsl *PutDSL) ProxyArpInterfaces(arp *l3.ProxyArpInterfaces_InterfaceList) vppplugin.PutDSL {
...
func (dsl *PutDSL) ProxyArpRanges(arp *l3.ProxyArpRanges_RangeList) vppplugin.PutDSL {
...
func (dsl *PutDSL) NAT44Global(nat44 *nat.Nat44Global) vppplugin.PutDSL {
	dsl.parent.txn.Put(nat.GlobalConfigKey(), nat44)
	return dsl
}

// NAT44DNat adds a request to create a new DNAT configuration
func (dsl *PutDSL) NAT44DNat(nat44 *nat.Nat44DNat_DNatConfig) vppplugin.PutDSL {
	dsl.parent.txn.Put(nat.DNatKey(nat44.Label), nat44)
	return dsl
}

// IPSecSA adds request to create a new Security Association
func (dsl *PutDSL) IPSecSA(sa *ipsec.SecurityAssociations_SA) vppplugin.PutDSL {
	dsl.parent.txn.Put(ipsec.SAKey(sa.Name), sa)
	return dsl
}

// IPSecSPD adds request to create a new Security Policy Database
func (dsl *PutDSL) IPSecSPD(spd *ipsec.SecurityPolicyDatabases_SPD) vppplugin.PutDSL {
...
// detection session.
func (dsl *DeleteDSL) BfdSession(bfdSessionIfaceName string) vppplugin.DeleteDSL {
...
// detection key.
func (dsl *DeleteDSL) BfdAuthKeys(bfdKey string) vppplugin.DeleteDSL {
...
func (dsl *DeleteDSL) StnRule(ruleName string) vppplugin.DeleteDSL {
...
// IPSecSA adds request to create a new Security Association
func (dsl *DeleteDSL) IPSecSA(saName string) vppplugin.DeleteDSL {
	dsl.parent.txn.Delete(ipsec.SAKey(saName))
	return dsl
}

// IPSecSPD adds request to create a new Security Policy Database
func (dsl *DeleteDSL) IPSecSPD(spdName string) vppplugin.DeleteDSL {
