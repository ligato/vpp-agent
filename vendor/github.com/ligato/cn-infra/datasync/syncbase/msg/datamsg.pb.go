...
// UnimplementedDataMsgServiceServer can be embedded to have forward compatible implementations.
type UnimplementedDataMsgServiceServer struct {
}

func (*UnimplementedDataMsgServiceServer) DataChanges(srv DataMsgService_DataChangesServer) error {
	return status.Errorf(codes.Unimplemented, "method DataChanges not implemented")
}
func (*UnimplementedDataMsgServiceServer) DataResyncs(ctx context.Context, req *DataResyncRequests) (*DataResyncReplies, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DataResyncs not implemented")
}
func (*UnimplementedDataMsgServiceServer) Ping(ctx context.Context, req *PingRequest) (*PingReply, error) {
