...
func (OperationalState) EnumDescriptor() ([]byte, []int) { return fileDescriptorStatus, []int{0} }
...
func (*AgentStatus) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{0} }
...
func (*PluginStatus) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{1} }
...
func (*InterfaceStats) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{2} }
...
func (*InterfaceStats_Interface) Descriptor() ([]byte, []int) {
	return fileDescriptorStatus, []int{2, 0}
}
