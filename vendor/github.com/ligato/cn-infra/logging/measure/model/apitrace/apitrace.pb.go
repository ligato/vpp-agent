...
func (*Trace) Descriptor() ([]byte, []int) {
	return fileDescriptor_c3b63931d9e5c188, []int{0}
}
...
func (*Trace_Entry) Descriptor() ([]byte, []int) {
	return fileDescriptor_c3b63931d9e5c188, []int{0, 0}
}
...
func (m *Trace_Entry) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Trace_Entry.Merge(m, src)
}
...
func (*Trace_EntryStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_c3b63931d9e5c188, []int{0, 1}
}
...
func (m *Trace_EntryStats) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Trace_EntryStats.Merge(m, src)
}
...
func init() { proto.RegisterFile("apitrace.proto", fileDescriptor_c3b63931d9e5c188) }

var fileDescriptor_c3b63931d9e5c188 = []byte{
