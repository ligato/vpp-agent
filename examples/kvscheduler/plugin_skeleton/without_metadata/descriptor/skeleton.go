...
import (
	...
	"go.ligato.io/vpp-agent/v2/examples/kvscheduler/plugin_skeleton/without_metadata/descriptor/adapter"
	"go.ligato.io/vpp-agent/v2/examples/kvscheduler/plugin_skeleton/without_metadata/model"
