...
type ProtoFileDescriptorResponse struct {
	...
	FileDescriptor *descriptor.FileDescriptorProto `protobuf:"bytes,1,opt,name=file_descriptor,json=fileDescriptor,proto3" json:"file_descriptor,omitempty"`
	...
	FileImportDescriptors *descriptor.FileDescriptorSet `protobuf:"bytes,2,opt,name=file_import_descriptors,json=fileImportDescriptors,proto3" json:"file_import_descriptors,omitempty"`
}
...
func (x *ProtoFileDescriptorResponse) GetFileDescriptor() *descriptor.FileDescriptorProto {
	if x != nil {
...
func (x *ProtoFileDescriptorResponse) GetFileImportDescriptors() *descriptor.FileDescriptorSet {
	if x != nil {
...
var file_ligato_generic_meta_proto_goTypes = []interface{}{
	...
	(*descriptor.FileDescriptorProto)(nil), // 5: google.protobuf.FileDescriptorProto
