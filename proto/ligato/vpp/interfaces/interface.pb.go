...
type IPSecLink struct {
	...
	// In VPP 21.06 and newer, IPSecLink serves just for creation of the link and thus all of the following
	// information is ignored. Please use separate messages for addition of SA and SPD instead.
