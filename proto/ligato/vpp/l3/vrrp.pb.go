...
type VRRPEntry struct {
	...
	PreemtpFlag bool     `protobuf:"varint,5,opt,name=preemtp_flag,json=preemtpFlag,proto3" json:"preemtp_flag,omitempty"`
	AcceptFlag  bool     `protobuf:"varint,6,opt,name=accept_flag,json=acceptFlag,proto3" json:"accept_flag,omitempty"`
	UnicastFlag bool     `protobuf:"varint,7,opt,name=unicast_flag,json=unicastFlag,proto3" json:"unicast_flag,omitempty"`
	Ipv6Flag    bool     `protobuf:"varint,8,opt,name=ipv6_flag,json=ipv6Flag,proto3" json:"ipv6_flag,omitempty"`
...
func (x *VRRPEntry) GetPreemtpFlag() bool {
	if x != nil {
		return x.PreemtpFlag
	}
	return false
}

func (x *VRRPEntry) GetAcceptFlag() bool {
	if x != nil {
		return x.AcceptFlag
	}
	return false
...
func (x *VRRPEntry) GetUnicastFlag() bool {
	if x != nil {
		return x.UnicastFlag
	}
	return false
}

func (x *VRRPEntry) GetIpv6Flag() bool {
	if x != nil {
		return x.Ipv6Flag
	}
	return false
...
var file_ligato_vpp_l3_vrrp_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x2e, 0x76, 0x70, 0x70, 0x2e, 0x6c, 0x33, 0x22, 0xaa, 0x02, 0x0a, 0x09, 0x56, 0x52,
	...
	,
