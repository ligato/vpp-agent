...
// DNSServer configuration models VPP's DNS cache server functionality. The main goal of this functionality is
//to cache DNS records and minimize external DNS traffic.
//The presence of this configuration enables the VPP DNS functionality and VPP start to acts as DNS Server.
...
func (x *DNSServer) GetUpstreamDnsServers() []string {
	if x != nil {
...
var file_ligato_vpp_dns_dns_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x2e, 0x76, 0x70, 0x70, 0x2e, 0x64, 0x6e, 0x73, 0x22, 0x3d, 0x0a, 0x09, 0x44, 0x4e,
	0x53, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12, 0x30, 0x0a, 0x14, 0x75, 0x70, 0x73, 0x74, 0x72,
	0x65, 0x61, 0x6d, 0x5f, 0x64, 0x6e, 0x73, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x73, 0x18,
	0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x12, 0x75, 0x70, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x44,
...
var file_ligato_vpp_dns_dns_proto_goTypes = []interface{}{
	(*DNSServer)(nil), // 0: ligato.vpp.dns.DNSServer
}
