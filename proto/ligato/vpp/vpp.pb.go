...
type ConfigData struct {
	...
	DnsServer              *dns.DNSServer                  `protobuf:"bytes,100,opt,name=dns_server,json=dnsServer,proto3" json:"dns_server,omitempty"`
}
...
func (x *ConfigData) GetDnsServer() *dns.DNSServer {
	if x != nil {
		return x.DnsServer
	}
	return nil
...
var file_ligato_vpp_vpp_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8d, 0x11, 0x0a, 0x0a, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	...
	0x65, 0x72, 0x52, 0x07, 0x77, 0x67, 0x50, 0x65, 0x65, 0x72, 0x73, 0x12, 0x38, 0x0a, 0x0a, 0x64,
	0x6e, 0x73, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x18, 0x64, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x19, 0x2e, 0x6c, 0x69, 0x67, 0x61, 0x74, 0x6f, 0x2e, 0x76, 0x70, 0x70, 0x2e, 0x64, 0x6e, 0x73,
	0x2e, 0x44, 0x4e, 0x53, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x52, 0x09, 0x64, 0x6e, 0x73, 0x53,
	0x65, 0x72, 0x76, 0x65, 0x72, 0x22, 0x5a, 0x0a, 0x0c, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x63,
...
var file_ligato_vpp_vpp_proto_goTypes = []interface{}{
	...
	(*dns.DNSServer)(nil),                    // 37: ligato.vpp.dns.DNSServer
...
var file_ligato_vpp_vpp_proto_depIdxs = []int32{
	...
	37, // 34: ligato.vpp.ConfigData.dns_server:type_name -> ligato.vpp.dns.DNSServer
