...
type IPRedirect struct {
	...
	L3Protocol L3Protocol `protobuf:"varint,1,opt,name=l3_protocol,json=l3Protocol,proto3,enum=ligato.vpp_agent.vpp.punt.L3Protocol" json:"l3_protocol,omitempty"`
...
type ToHost struct {
	...
	L3Protocol L3Protocol `protobuf:"varint,2,opt,name=l3_protocol,json=l3Protocol,proto3,enum=ligato.vpp_agent.vpp.punt.L3Protocol" json:"l3_protocol,omitempty"`
	// L4 destination protocol a packet has to match.
	// Currently VPP only supports UDP.
	L4Protocol L4Protocol `protobuf:"varint,3,opt,name=l4_protocol,json=l4Protocol,proto3,enum=ligato.vpp_agent.vpp.punt.L4Protocol" json:"l4_protocol,omitempty"`
	// Destination port
...
func init() {
	proto.RegisterEnum("ligato.vpp_agent.vpp.punt.L3Protocol", L3Protocol_name, L3Protocol_value)
	proto.RegisterEnum("ligato.vpp_agent.vpp.punt.L4Protocol", L4Protocol_name, L4Protocol_value)
	proto.RegisterType((*IPRedirect)(nil), "ligato.vpp_agent.vpp.punt.IPRedirect")
	proto.RegisterType((*ToHost)(nil), "ligato.vpp_agent.vpp.punt.ToHost")
	proto.RegisterType((*Exception)(nil), "ligato.vpp_agent.vpp.punt.Exception")
	proto.RegisterType((*Reason)(nil), "ligato.vpp_agent.vpp.punt.Reason")
}
...
var fileDescriptor_44e21c3981ca4881 = []byte{
	...
	,
}
