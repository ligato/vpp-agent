...
type Interface struct {
	...
	Type Interface_Type `protobuf:"varint,2,opt,name=type,proto3,enum=ligato.vpp_agent.linux.interfaces.Interface_Type" json:"type,omitempty"`
...
type VethLink struct {
	...
	RxChecksumOffloading VethLink_ChecksumOffloading `protobuf:"varint,2,opt,name=rx_checksum_offloading,json=rxChecksumOffloading,proto3,enum=ligato.vpp_agent.linux.interfaces.VethLink_ChecksumOffloading" json:"rx_checksum_offloading,omitempty"`
	// Checksum offloading - Tx side (enabled by default)
	TxChecksumOffloading VethLink_ChecksumOffloading `protobuf:"varint,3,opt,name=tx_checksum_offloading,json=txChecksumOffloading,proto3,enum=ligato.vpp_agent.linux.interfaces.VethLink_ChecksumOffloading" json:"tx_checksum_offloading,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                    `json:"-"`
	XXX_unrecognized     []byte                      `json:"-"`
	XXX_sizecache        int32                       `json:"-"`
}
...
func init() {
	proto.RegisterEnum("ligato.vpp_agent.linux.interfaces.Interface_Type", Interface_Type_name, Interface_Type_value)
	proto.RegisterEnum("ligato.vpp_agent.linux.interfaces.VethLink_ChecksumOffloading", VethLink_ChecksumOffloading_name, VethLink_ChecksumOffloading_value)
	proto.RegisterType((*Interface)(nil), "ligato.vpp_agent.linux.interfaces.Interface")
	proto.RegisterType((*VethLink)(nil), "ligato.vpp_agent.linux.interfaces.VethLink")
	proto.RegisterType((*TapLink)(nil), "ligato.vpp_agent.linux.interfaces.TapLink")
}
...
var fileDescriptor_c9d345437a2847b7 = []byte{
	...
	,
}
